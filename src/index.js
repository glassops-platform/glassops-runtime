...
var policy_1 = require("./protocol/policy");
var cli_1 = require("./services/cli");
var identity_1 = require("./services/identity");
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var policyEngine, config, runtime, identity, orgId, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    policyEngine = new policy_1.ProtocolPolicy();
                    return [4 /*yield*/, policyEngine.load()];
                case 1:
                    config = _a.sent();
                    ...
                    runtime = new cli_1.RuntimeEnvironment();
                    return [4 /*yield*/, runtime.install(config.runtime.cli_version)];
                case 2:
                    _a.sent();
                    identity = new identity_1.IdentityResolver();
                    return [4 /*yield*/, identity.authenticate({
